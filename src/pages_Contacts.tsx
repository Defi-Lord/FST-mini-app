...
export default function ContactUs({ onBack }: Props) {
  const links = [
    ...
    { label: 'Telegram', href: 'https://t.me/', key: 'telegram' },
    { label: 'Discord',  href: 'https://discord.com/invite/', key: 'discord' },
  ]
  return (
    <div className="screen">
      <style>{`
        ...
        .cta {
          ...
          color:#fff; text-decoration:none; font-weight:900; letter-spacing:.3px;
